...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "SwiftRapid",
            dependencies: ["SwiftProtobuf", "xxHash-Swift", .product(name: "Backtrace", package: "swift-backtrace"), .product(name: "NIO", package: "swift-nio"), .product(name: "GRPC", package: "grpc-swift") ]),
        .testTarget(
